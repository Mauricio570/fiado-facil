...
public class VendaController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<VendaResponse> editar(@PathVariable Long id, @Valid @RequestBody VendaRequest request) {
        return ResponseEntity.ok(vendaService.editar(id, request));
    }
